...
Usage Example:
    EXEC Silver.BulkInsertData;
===============================================================================
*/

CREATE OR ALTER PROCEDURE silver.BulkInsertData AS
BEGIN
    ...
    BEGIN TRY
		...
		SELECT
			...
			CASE
				WHEN UPPER(REPLACE(TRIM(gen), CHAR(13), '')) IN ('F', 'FEMALE') THEN 'Female'
		...
		SELECT
			...
			cat,
			subcat,
			TRIM(REPLACE(maintenance, CHAR(13), '')) AS maintenance -- Remove carriage return characters from maintenance field
